...
* **Descripción:** Estudiante de Ingeniería de Software de la Universidad Peruana de Ciencias Aplicadas (UPC). Interesado en el desarrollo de software financiero, arquitectura en la nube (AWS) y análisis de datos. Cuenta con conocimientos en modelado Domain-Driven Design (DDD, EventStorming, C4), integración de APIs y servicios web, así como experiencia en investigación de usuarios y levantamiento de requerimientos de negocio.
